...
<x-page-header title="Edit Subscription Plan" :back="route('super.plans.index')" :subtitle="$plan->name"/>
...
<div class="row justify-content-center">
    <div class="col-12 col-lg-7">
        ...
        <div class="alert alert-warning d-flex align-items-start gap-2 mb-4">
            ...
            <div>
                This plan has <strong>{{ $plan->tenants_count }}</strong> active tenant(s).
                Price changes will apply to new subscribers only.
            </div>
        </div>
        @endif
                ...
                <form method="POST" action="{{ route('super.plans.update', $plan) }}">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="number" name="max_courts"
                                   value="{{ old('max_courts', $plan->max_courts) }}"
                                   min="1" placeholder="Unlimited"
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="number" name="max_staff"
